...
## Featured Projects
  ...
  ### 🅿️ParkMe
  <p>Collaborative project developed together with a teammate. Smart parking system that allows users to check the number of available parking spaces in real time.</p>
